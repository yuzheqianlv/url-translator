...
fn AppHeader() -> impl IntoView {
    ...
    view! {
        <header class="shadow-sm border-b" style="background-color: var(--color-surface0); border-color: var(--color-surface1)">
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center space-x-4">
                        <A href="/" class="text-xl font-bold transition-colors hover:opacity-80 themed-text">
                            "URL翻译工具"
                        </A>
                    </div>
                    ...
                    <nav class="flex items-center space-x-6">
                        ...
                        <button
                            ...
                            style="background-color: var(--color-surface1); color: var(--color-text)"
