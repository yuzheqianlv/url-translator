    ...
    view! {
        <div class="rounded-lg shadow-lg p-6 themed-bg-surface0">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold themed-text">
                    "翻译结果"
                </h2>
                <Show when=move || !translation_result.get().is_empty()>
                    <button
                        class="px-4 py-2 rounded-md flex items-center space-x-2 transition-colors hover:opacity-90 themed-button-success"
            ...
            <div class="min-h-[300px] max-h-[600px] overflow-y-auto">
                <Show
                    ...
                    fallback=|| view! {
                        <div class="flex items-center justify-center h-48 themed-subtext">
                            <div class="text-center">
                                <svg class="w-12 h-12 mx-auto mb-4 themed-subtext0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                    <div class="prose prose-sm max-w-none">
                        <pre class="whitespace-pre-wrap text-sm leading-relaxed p-4 rounded themed-content-bg">
